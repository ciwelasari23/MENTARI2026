            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50" 
                    ...
                    <td class="p-3 text-center whitespace-nowrap space-x-1">
                        ...
                        }; modalDetail = true" class="bg-sky-500 hover:bg-sky-600 text-white px-3 py-1.5 rounded-lg text-xs font-semibold">
                            Detail
                        </button>
                        ...
                        <button @click="editData = {
                            ...
                            target_daerah: '{{ $item->target_daerah }}'
                        }; modalEdit = true" class="bg-amber-500 hover:bg-amber-600 text-white px-3 py-1.5 rounded-lg text-xs font-semibold">
                            Edit
                        </button>
