            ...
            <form method="POST" action="{{ route('login.post') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <!-- Atribut value="secret" telah dihapus di bawah ini -->
                        <input :type="showPassword ? 'text' : 'password'" name="password" required class="form-input has-icon has-icon-right" placeholder="Masukkan Password">
